      ...
      <article className="p-2">
        ...
        <section>
          ...
          <p>
            ...
            applications and enrich my professional experience. I'm ready to
            start a career in software development.
          </p>
          <p>
            My skills include both frontend and backend development. I have
            experience working with various technologies and programming
            languages such as JavaScript, Python and PHP.{' '}
          </p>
          <p>
            You can find my profiles on LinkedIn and GitHub for more details
            about my experience and the projects I've worked on:
            <ul>
              <li>
                <a
        ...
        <section>
          ...
          <p>
            Countries is a simple React application that was developed as part
            of a class at Business College Helsinki. It allows you to explore
